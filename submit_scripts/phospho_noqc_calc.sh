...
singularity exec cytof_workflow_v3.sif Rscript --vanilla scripts/script1_arcsinh.R meta/phospho_noqc_20_10k.yaml
singularity exec cytof_workflow_v3.sif Rscript --vanilla scripts/script2_clust.R meta/phospho_noqc_20_10k.yaml
singularity exec cytof_workflow_v3.sif Rscript --vanilla scripts/script3_dr.R meta/phospho_noqc_20_10k.yaml
